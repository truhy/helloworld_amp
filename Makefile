...
DBG_PATH1 := $(APP_OUT_PATH)/DebugApp1
DBG_FULL_PATH1 := $(APP_OUT_FULL_PATH)/DebugApp1
...
REL_PATH1 := $(APP_OUT_PATH)/ReleaseApp1
REL_FULL_PATH1 := $(APP_OUT_FULL_PATH)/ReleaseApp1
...
DBG_PATH2 := $(APP_OUT_PATH)/DebugApp2
DBG_FULL_PATH2 := $(APP_OUT_FULL_PATH)/DebugApp2
DBG_ELF2 := $(DBG_PATH2)/$(APP_PROGRAM_NAME2).elf
DBG_ELF_LOAD_FILE2 := $(DBG_PATH2)/$(APP_PROGRAM_NAME2).load.txt
DBG_ELF_ENTRY_FILE2 := $(DBG_PATH2)/$(APP_PROGRAM_NAME2).entry.txt
DBG_BIN2 := $(DBG_PATH2)/$(APP_PROGRAM_NAME2).bin
DBG_UIMG2 := $(DBG_PATH2)/$(APP_PROGRAM_NAME2).uimg

REL_PATH2 := $(APP_OUT_PATH)/ReleaseApp2
REL_FULL_PATH2 := $(APP_OUT_FULL_PATH)/ReleaseApp2
REL_ELF2 := $(REL_PATH2)/$(APP_PROGRAM_NAME2).elf
REL_ELF_LOAD_FILE2 := $(REL_PATH2)/$(APP_PROGRAM_NAME2).load.txt
REL_ELF_ENTRY_FILE2 := $(REL_PATH2)/$(APP_PROGRAM_NAME2).entry.txt
REL_BIN2 := $(REL_PATH2)/$(APP_PROGRAM_NAME2).bin
REL_UIMG2 := $(REL_PATH2)/$(APP_PROGRAM_NAME2).uimg
...
ifeq ($(uimg),1)
DBG_UBOOT_SCRTXT_L6_STR := fatload mmc $(SDFATDEVPART) \$${loadaddr} $(APP_PROGRAM_NAME2).uimg
DBG_UBOOT_SCRTXT_L7_STR := setenv autostart n; bootm \$${loadaddr}
DBG_UBOOT_SCRTXT_L8_STR := fatload mmc $(SDFATDEVPART) \$${loadaddr} $(APP_PROGRAM_NAME1).uimg
DBG_UBOOT_SCRTXT_L9_STR := setenv autostart y; bootm \$${loadaddr}
ifneq (,$(UBOOT_SCRTXT_ARGS_STR))
DBG_UBOOT_SCRTXT_L9_STR := $(DBG_UBOOT_SCRTXT_L9_STR) $(UBOOT_SCRTXT_ARGS_STR)
endif
else
ifeq ($(bin),1)
DBG_UBOOT_SCRTXT_L6_STR = fatload mmc $(SDFATDEVPART) $(DBG_ELF_LOAD_TEXT2) $(APP_PROGRAM_NAME2).bin
DBG_UBOOT_SCRTXT_L7_STR = fatload mmc $(SDFATDEVPART) $(DBG_ELF_LOAD_TEXT1) $(APP_PROGRAM_NAME1).bin
ifeq (,$(UBOOT_SCRTXT_ARGS_STR))
DBG_UBOOT_SCRTXT_L8_STR = go $(DBG_ELF_ENTRY_TEXT1)
else
DBG_UBOOT_SCRTXT_L8_STR = go $(DBG_ELF_ENTRY_TEXT1) $(UBOOT_SCRTXT_ARGS_STR)
endif
endif
endif
endif
...
ifeq ($(uimg),1)
REL_UBOOT_SCRTXT_L6_STR := fatload mmc $(SDFATDEVPART) \$${loadaddr} $(APP_PROGRAM_NAME2).uimg
REL_UBOOT_SCRTXT_L7_STR := setenv autostart n; bootm \$${loadaddr}
REL_UBOOT_SCRTXT_L8_STR := fatload mmc $(SDFATDEVPART) \$${loadaddr} $(APP_PROGRAM_NAME1).uimg
REL_UBOOT_SCRTXT_L9_STR := setenv autostart y; bootm \$${loadaddr}
ifneq (,$(UBOOT_SCRTXT_ARGS_STR))
REL_UBOOT_SCRTXT_L9_STR := $(REL_UBOOT_SCRTXT_L9_STR) $(UBOOT_SCRTXT_ARGS_STR)
endif
else
ifeq ($(bin),1)
REL_UBOOT_SCRTXT_L6_STR = fatload mmc $(SDFATDEVPART) $(REL_ELF_LOAD_TEXT2) $(APP_PROGRAM_NAME2).bin
REL_UBOOT_SCRTXT_L7_STR = fatload mmc $(SDFATDEVPART) $(REL_ELF_LOAD_TEXT1) $(APP_PROGRAM_NAME1).bin
ifeq (,$(UBOOT_SCRTXT_ARGS_STR))
REL_UBOOT_SCRTXT_L8_STR = go $(REL_ELF_ENTRY_TEXT1)
else
REL_UBOOT_SCRTXT_L8_STR = go $(REL_ELF_ENTRY_TEXT1) $(UBOOT_SCRTXT_ARGS_STR)
endif
endif
endif
endif
...
DBG_SD_UIMG1 := $(addprefix $(DBG_SD_OUT_SUB_PATH)/$(SDFATFOLDER)/,$(notdir $(DBG_UIMG1)))
DBG_SD_UIMG2 := $(addprefix $(DBG_SD_OUT_SUB_PATH)/$(SDFATFOLDER)/,$(notdir $(DBG_UIMG2)))
DBG_SD_BIN1 :=  $(addprefix $(DBG_SD_OUT_SUB_PATH)/$(SDFATFOLDER)/,$(notdir $(DBG_BIN1)))
DBG_SD_BIN2 :=  $(addprefix $(DBG_SD_OUT_SUB_PATH)/$(SDFATFOLDER)/,$(notdir $(DBG_BIN2)))
...
REL_SD_UIMG1 := $(addprefix $(REL_SD_OUT_SUB_PATH)/$(SDFATFOLDER)/,$(notdir $(REL_UIMG1)))
REL_SD_UIMG2 := $(addprefix $(REL_SD_OUT_SUB_PATH)/$(SDFATFOLDER)/,$(notdir $(REL_UIMG2)))
REL_SD_BIN1 :=  $(addprefix $(REL_SD_OUT_SUB_PATH)/$(SDFATFOLDER)/,$(notdir $(REL_BIN1)))
REL_SD_BIN2 :=  $(addprefix $(REL_SD_OUT_SUB_PATH)/$(SDFATFOLDER)/,$(notdir $(REL_BIN2)))
...
# File exists?
ifneq (,$(wildcard $(DBG_ELF_LOAD_FILE2)))
DBG_ELF_LOAD_TEXT2 := $(file <$(DBG_ELF_LOAD_FILE2))
endif
# File exists?
ifneq (,$(wildcard $(REL_ELF_LOAD_FILE2)))
REL_ELF_LOAD_TEXT2 := $(file <$(REL_ELF_LOAD_FILE2))
endif
...
# File exists?
ifneq (,$(wildcard $(DBG_ELF_ENTRY_FILE2)))
DBG_ELF_ENTRY_TEXT2 := $(file <$(DBG_ELF_ENTRY_FILE2))
endif
# File exists?
ifneq (,$(wildcard $(REL_ELF_ENTRY_FILE2)))
REL_ELF_ENTRY_TEXT2 := $(file <$(REL_ELF_ENTRY_FILE2))
endif
...
clean_app:
	...
	make -f Makefile-app2.mk --no-print-directory clean
...
clean_1:
	...
	@if [ -d "$(DBG_PATH2)" ]; then echo rm -rf "$(DBG_PATH2)"; rm -rf "$(DBG_PATH2)"; fi
	@if [ -d "$(REL_PATH2)" ]; then echo rm -rf "$(REL_PATH2)"; rm -rf "$(REL_PATH2)"; fi
...
cleantemp_app:
	...
	make -f Makefile-app2.mk --no-print-directory cleantemp
...
$(DBG_ELF_LOAD_FILE2): dbg_make_elf
	$(eval DBG_ELF_LOAD_TEXT2 := $(file <$(DBG_ELF_LOAD_FILE2)))

$(REL_ELF_LOAD_FILE2): rel_make_elf
	$(eval REL_ELF_LOAD_TEXT2 := $(file <$(REL_ELF_LOAD_FILE2)))
...
$(DBG_ELF_ENTRY_FILE2): dbg_make_elf
	$(eval DBG_ELF_ENTRY_TEXT2 := $(file <$(DBG_ELF_ENTRY_FILE2)))

$(REL_ELF_ENTRY_FILE2): rel_make_elf
	$(eval REL_ELF_ENTRY_TEXT2 := $(file <$(REL_ELF_ENTRY_FILE2)))
...
# Add prerequisite to list
DBG_SCR_PRE := $(DBG_SCR_PRE) $(DBG_ELF_LOAD_FILE1) $(DBG_ELF_ENTRY_FILE1) $(DBG_ELF_LOAD_FILE2) $(DBG_ELF_ENTRY_FILE2)
REL_SCR_PRE := $(REL_SCR_PRE) $(REL_ELF_LOAD_FILE1) $(REL_ELF_ENTRY_FILE1) $(REL_ELF_LOAD_FILE2) $(REL_ELF_ENTRY_FILE2)
...
$(DBG_UBOOT_SCRTXT): $(DBG_SCR_PRE)
	...
	@if [ -n "$(DBG_UBOOT_SCRTXT_L8_STR)" ]; then echo "$(DBG_UBOOT_SCRTXT_L8_STR)" >> "$@"; fi
	@if [ -n "$(DBG_UBOOT_SCRTXT_L9_STR)" ]; then echo "$(DBG_UBOOT_SCRTXT_L9_STR)" >> "$@"; fi
...
$(REL_UBOOT_SCRTXT): $(REL_SCR_PRE)
	...
	@if [ -n "$(REL_UBOOT_SCRTXT_L8_STR)" ]; then echo "$(REL_UBOOT_SCRTXT_L8_STR)" >> "$@"; fi
	@if [ -n "$(REL_UBOOT_SCRTXT_L9_STR)" ]; then echo "$(REL_UBOOT_SCRTXT_L9_STR)" >> "$@"; fi
...
# Add to prerequisite list
ifeq ($(uimg),1)
DBG_SD_IMG_PRE := $(DBG_SD_IMG_PRE) $(DBG_SD_UIMG1) $(DBG_SD_UIMG2)
REL_SD_IMG_PRE := $(REL_SD_IMG_PRE) $(REL_SD_UIMG1) $(REL_SD_UIMG2)
endif
ifeq ($(bin),1)
DBG_SD_IMG_PRE := $(DBG_SD_IMG_PRE) $(DBG_SD_BIN1) $(DBG_SD_BIN2)
REL_SD_IMG_PRE := $(REL_SD_IMG_PRE) $(REL_SD_BIN1) $(REL_SD_BIN2)
endif
...
$(DBG_SD_UIMG1): $(DBG_UIMG1)
	@mkdir -p "$(@D)"
	@cp -f "$(DBG_UIMG1)" "$@"

$(DBG_SD_BIN1): $(DBG_BIN1)
	@mkdir -p "$(@D)"
	@cp -f "$(DBG_BIN1)" "$@"

$(DBG_SD_UIMG2): $(DBG_UIMG2)
	@mkdir -p "$(@D)"
	@cp -f "$(DBG_UIMG2)" "$@"

$(DBG_SD_BIN2): $(DBG_BIN2)
	@mkdir -p "$(@D)"
	@cp -f "$(DBG_BIN2)" "$@"
...
$(REL_SD_UIMG1): $(REL_UIMG1)
	@mkdir -p "$(@D)"
	@cp -f "$(REL_UIMG1)" "$@"

$(REL_SD_BIN1): $(REL_BIN1)
	@mkdir -p "$(@D)"
	@cp -f "$(REL_BIN1)" "$@"

$(REL_SD_UIMG2): $(REL_UIMG2)
	@mkdir -p "$(@D)"
	@cp -f "$(REL_UIMG2)" "$@"

$(REL_SD_BIN2): $(REL_BIN2)
	@mkdir -p "$(@D)"
	@cp -f "$(REL_BIN2)" "$@"
