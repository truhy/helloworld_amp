...
DBG_PATH1 := $(BM_OUT_PATH)/DebugApp1
...
REL_PATH1 := $(BM_OUT_PATH)/ReleaseApp1
...
DBG_PATH2 := $(BM_OUT_PATH)/DebugApp2
DBG_ELF2 := $(DBG_PATH2)/$(BM_PROGRAM_NAME2).elf
DBG_ELF_LOAD_FILE2 := $(DBG_PATH2)/$(BM_PROGRAM_NAME2).load.txt
DBG_ELF_ENTRY_FILE2 := $(DBG_PATH2)/$(BM_PROGRAM_NAME2).entry.txt
DBG_BIN2 := $(DBG_PATH2)/$(BM_PROGRAM_NAME2).bin
DBG_UIMG2 := $(DBG_PATH2)/$(BM_PROGRAM_NAME2).uimg

REL_PATH2 := $(BM_OUT_PATH)/ReleaseApp2
REL_ELF2 := $(REL_PATH2)/$(BM_PROGRAM_NAME2).elf
REL_ELF_LOAD_FILE2 := $(REL_PATH2)/$(BM_PROGRAM_NAME2).load.txt
REL_ELF_ENTRY_FILE2 := $(REL_PATH2)/$(BM_PROGRAM_NAME2).entry.txt
REL_BIN2 := $(REL_PATH2)/$(BM_PROGRAM_NAME2).bin
REL_UIMG2 := $(REL_PATH2)/$(BM_PROGRAM_NAME2).uimg
...
ifeq ($(uimg),1)
DBG_UBOOT_SCRTXT_L6_STR := fatload mmc $(SDFATDEVPART) \$${loadaddr} $(BM_PROGRAM_NAME2).uimg
DBG_UBOOT_SCRTXT_L7_STR := setenv autostart n; bootm \$${loadaddr}
DBG_UBOOT_SCRTXT_L8_STR := fatload mmc $(SDFATDEVPART) \$${loadaddr} $(BM_PROGRAM_NAME1).uimg
...
ifeq ($(bin),1)
DBG_UBOOT_SCRTXT_L6_STR = fatload mmc $(SDFATDEVPART) $(DBG_ELF_LOAD_TEXT2) $(BM_PROGRAM_NAME2).bin
DBG_UBOOT_SCRTXT_L7_STR = fatload mmc $(SDFATDEVPART) $(DBG_ELF_LOAD_TEXT1) $(BM_PROGRAM_NAME1).bin
...
ifeq ($(uimg),1)
REL_UBOOT_SCRTXT_L6_STR := fatload mmc $(SDFATDEVPART) \$${loadaddr} $(BM_PROGRAM_NAME2).uimg
REL_UBOOT_SCRTXT_L7_STR := setenv autostart y; bootm \$${loadaddr}
REL_UBOOT_SCRTXT_L8_STR := fatload mmc $(SDFATDEVPART) \$${loadaddr} $(BM_PROGRAM_NAME1).uimg
...
ifeq ($(bin),1)
REL_UBOOT_SCRTXT_L6_STR = fatload mmc $(SDFATDEVPART) $(REL_ELF_LOAD_TEXT2) $(BM_PROGRAM_NAME2).bin
REL_UBOOT_SCRTXT_L7_STR = fatload mmc $(SDFATDEVPART) $(REL_ELF_LOAD_TEXT1) $(BM_PROGRAM_NAME1).bin
ifeq (,$(UBOOT_SCRTXT_ARGS_STR))
